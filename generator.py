...
def send_welcome(message):
	...
	v= types.InlineKeyboardButton("Developer ⸙",url='https://t.me/IIlAndylII')
	mas.add(v)
	ru = message.from_user.first_name
	Ruk=bot.send_message(message.chat.id,f"""
-- -- -- -- - -- -- -- -- -- -- -- -- --
≈ welcome [{ru}](t.me/IIlAndylII) ⸙
...
def send_welcome(message):
	...
	if message.text =='Start ⸙':
		...
		D = types.InlineKeyboardButton("Developer ⸙",url='https://t.me/IIlAndylII')
		mar= types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=2)
